export const data = [
  ...
  },
  {
    ...
    markup: `
      ...
      <div class="desc">
        ...
        <p>
          Honduras ha rebautizado el sitio como la “Ciudad Perdida del Jaguar” basada en las antiguas esculturas de jaguares encontradas por los arqueólogos, así como también la presencia de jaguares vivos registrados por las cámaras trampa este año. Se encuentra en el corazón del Corredor Biológico Mesoamericano de Honduras y Nicaragua, también conocido como el Corredor Forestal de Moskitia, uno de los cinco bloques forestales más grandes que quedan en América Central.Tales avistamientos en Mesoamérica son bastante poco frecuentes. La aparición de este animal en este sitio, que no había sido visitado por seres humanos durante 500 años, señala a Ciudad Blanca como una joya. Pero no permanecerá así sin esfuerzos previsores de conservación a gran escala.
        </p>
      </div>
    `,
  },
  ...
  },
  {
    ...
    markup: `
      ...
      <div class="desc">
        ...
        <p class="italic">
          “For 130 years, National Geographic has documented the stories of our planet, providing audiences around the world with a window into the earth’s breathtaking beauty as well as to the threats it faces,” said <span>Gary E. Knell, CEO of National Geographic Partners.</span> “Each and every day, our explorers, researchers and photographers in the field witness firsthand the devastating impact of single-use plastic on our oceans, and the situation is becoming increasingly dire. Through the Planet or Plastic? initiative, we will share the stories of this growing crisis, work to address it through the latest science and research, and educate audiences around the world about how to eliminate single-use plastics and prevent them from making their way into our oceans.”
        </p>
        <p>
          Almost 3 million students in 10,000 schools in all 50 states, the District of Columbia, U.S. Atlantic and Pacific territories and Department of Defense Dependents Schools took part in the 2018 National Geographic Bee.
        </p>
  ...
  {
    title: 'National Geographic Society Announces Winners of Competition to Combat Illegal Fishing',
    subTitle: `The Society’s Marine Protection Prize awards $450,000 for innovative solutions and technologies that protect and sustain fisheries in coastal communities`,
    markup: `
